...
public class ShowTipsBuilder {
	...
	public ShowTipsBuilder setBitmapRes(int bitmapRes){
		this.showtipsView.setBitmapRes(bitmapRes);
		return this;
	}
	
	public ShowTipsBuilder setDescriptionBitmapRes(int bitmapRes){
		this.showtipsView.setDescriptionBitmapRes(bitmapRes);
		return this;
	}
